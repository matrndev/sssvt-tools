...
export default function TimetableError() {
  return (
    <main lang="cs" className="mx-auto w-full max-w-360 p-8">
      <h1 className="text-2xl font-semibold">Couldn&apos;t load timetable.</h1>
      <p className="mt-3 text-slate-400">The database is currently unavailable. Please try again later.</p>
